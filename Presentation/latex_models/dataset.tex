...
{\includegraphics[width=5cm,height=5cm]{./../images/0}};
...
{\includegraphics[width=5cm,height=5cm]{./../images/1}};
...
{\includegraphics[width=5cm,height=5cm]{./../images/2}};
...
{\includegraphics[width=5cm,height=5cm]{./../images/3}};
...
{\includegraphics[width=5cm,height=5cm]{./../images/4}};
