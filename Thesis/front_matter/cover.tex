...
\rule{0.0\linewidth}{0.8pt}

%\Large
%\headerline {School of Industrial and Information Engineering}
\Large
...
\newcommand {\prof} [4]
{\Large \quad #1 \textsc {#2}\large{#3} ---
\large #4 \hspace {8.3mm} \= \\}
\begin {tabbing}
\large Supervisor: \\
\prof {Giacomo} {Boracchi,}{ Ph.D.} {Politecnico di Milano}
\large Co-Supervisor: \\
\prof {Diego} {Carrera}{\quad\quad\quad\quad\quad} {Politecnico di Milano}
