...
width=2,depth=5}};
\pic[shift={(2,0,0)}] at (input-east)
{Box={name=cvt1,caption=convt1,xlabel={{"512","dummy"}},ylabel=,zlabel=,fill=\ConvTColor,height=50,width=2,depth=50}};
...
width=8,depth=5}};
\pic[shift={(2,0,0)}] at (bnlr3-east)
{Box={name=cvt3,caption=convt3,xlabel={{"128","dummy"}},ylabel=,zlabel=,fill=\ConvTColor,height=30,width=8,depth=30}};
...
{Box={name=cv1,caption=conv1,xlabel={{"32","dummy"}},ylabel=,zlabel=,fill=\ConvColor,height=30,width=8,depth=30}};
...
{Box={name=cv3,caption=conv3,xlabel={{"128","dummy"}},ylabel=,zlabel=,fill=\ConvColor,height=50,width=2,depth=50}};
